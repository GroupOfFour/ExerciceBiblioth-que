...
/**
 * Une classe d'action Struts 2 pour traiter les requetes liées à la gestion
 * des livres. Cette classe fait appel à la couche Services métiers pour
 * répondres aux requetes
 * 
...
public class BookAction extends BaseAction {
    ...
    /**
     * Représente la liste des thèmes, cette liste est utilisée pour
     * construire un combobox contenant les noms des thèmes dans les vues
     */
    ...
    /**
     * Cette méthode n'est pas une méthode d'action elle factorise un
     * traitement répétitive
     */
    private void initFormBook() {

        // on charge les données d'initialisation du formulaire
        // Ces données peuvent etre stockées dans la session de l'utilisateur
        // si
    ...
    /**
     * Méthode d'action utilisée pour initialiser le formulaire de mise à
     * jour
     * 
     * 
     * @return
    ...
    public String showFormUpdate() {
        ...
        if ( idbook != null && !idbook.isEmpty() ) {
            ...
            try {
                ...
                // avec les
                // informations du livre trouvé (cas de modification d'un
                // livre)
    ...
    public String processFormData() {
        ...
        // car la méthode getThemeByNom déclenche une exception si le livre
        // est
        // introuvable
