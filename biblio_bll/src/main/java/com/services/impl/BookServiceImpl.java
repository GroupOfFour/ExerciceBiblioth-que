...
public class BookServiceImpl implements BookService {
    ...
    /**
     * dépendance avec le DAO gérant les livres. Spring injetera une instance
     * de BookDaoImpl dans cette variable
     */
    @Autowired
    private BookDao  bookDao;

    /**
     * dépendance avec le DAO gérant les rayons. Spring injetera une instance
     * de RayonDaoImpl dans cette variable
     */
    @Autowired
    private RayonDao rayonDao;

    /**
     * dépendance avec le DAO gérant les themes. Spring injetera une instance
     * de ThemeDaoImpl dans cette variable
     */
